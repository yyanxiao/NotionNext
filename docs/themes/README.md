...
| ThoughtLite（移植中） | [THOUGHTLITE.md](./THOUGHTLITE.md) | 见 [THOUGHTLITE.md](./THOUGHTLITE.md)（计划：[THOUGHTLITE_MIGRATION_PLAN.zh-CN.md](./THOUGHTLITE_MIGRATION_PLAN.zh-CN.md)） |
